namespace ExampleChatConsoleApp
{
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                else if (myGuess > targetNumber)
                {
                    ...
                    {
                        Console.WriteLine("Neredeyse bildin. Sayıyı bence bir tane azalt");
                    }
                    else {
                    ...
                    {
                        Console.WriteLine("Tuttuğun sayıdan daha küçük bir tahminde bulundunuz");
                    }                
                }
            }
        }
